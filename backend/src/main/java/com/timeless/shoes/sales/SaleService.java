...
public class SaleService {
    ...
    /**
     * List all sales (optional date filter)
     */
    ...
    public SaleDto createSale(CreateSaleRequest request) {
        ...
        for (SaleItemDto itemDto : request.getItems()) {
            ...
            SaleItem saleItem = new SaleItem(sale, variant, itemDto.getQuantity(), variant.getSellingPrice(), itemTotal);
            items.add(saleItem);
        }
